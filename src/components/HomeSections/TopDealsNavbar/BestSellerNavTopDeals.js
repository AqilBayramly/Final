...
import ArrivalSaleBox from './ArrivalSaleBox/ArrivalSaleBox'
import ArrivalNewBox from './ArrivalNewBox/ArrivalNewBox'
...
function BestSellerNavTopDeals() {
  return (
    <div>    
    ...
    <>
        ...
        <SwiperSlide>
                <div className='new__arrival__box'>
                    ...
                    <ArrivalNewBox></ArrivalNewBox>
                    <ArrivalSaleBox></ArrivalSaleBox>
                    ...
                    <div className='star__and__price'>
                        ...
                        <span className='top__deals__new__price'>$49.00 </span>
                        <span className='top__deals__old__price'> $80.00</span>
                    </div>
                </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
                <div className='new__arrival__box'>
                    ...
                    <a href='#!'>
                        ...
                        <p className='top__deal__image__text'>Canon 800</p>
                    </a>
                    <div className='star__and__price'>
                        ...
                        <span className='top__deals__new__price'>$119.00 </span>
                        <span className='top__deals__old__price'> $189.00</span>
                    </div>
                </div>
            </SwiperSlide>
...
export default BestSellerNavTopDeals